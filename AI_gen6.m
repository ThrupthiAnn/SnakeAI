function [direction, data] = AI_gen6(nrows, snake, food, data)
% logic: shortest path to the food or longest path to tail. If it doesn't exist, clockwise
...
direction = ShortestPath(disttrans, snake);
if direction==0
...
function direction = ShortestPath(disttrans, snake)
snake = snake(1,:);
nrows =  size(disttrans, 1);
shortest = Inf;
direction = 0;
