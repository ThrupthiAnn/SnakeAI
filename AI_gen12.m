function [direction, data] = AI_gen12(nrows, snake, food, data)
% LOGIC: Follow Random Hamiltonian path.. Take short-cut if there is no snake in
...
data = RandomHamilton(nrows, nrows*100);
end
graph = data;
